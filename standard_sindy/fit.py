...
def fit1(u: np.ndarray,
    ...
    original_model = ps.SINDy(feature_library=polynomial_lib, optimizer=optimizer, differentiation_method=FiniteDifference())
...
def main() -> None:
    ...
    model_all = fit1(coordinate_data_noise_window, t_window)
